#include "Code/Dict.C"
{
  ...
  TChain c("ttree");
  c.Add("root://eoscms//eos/cms/store/group/dpg_tracker_strip/comm_tracker/Strip/RadMonitoring/SignalBiasScan/ClustersTrees/DecoSmallHVScan_20150821_run254790_v1_3/clustersTree_*.root/demo/ttree");
  ...
  SignalAnalysisTreeMaker *t = new SignalAnalysisTreeMaker(&c, "../VoltageSteps/Steps/Steps_20150821_run254790.txt", subdet, usetimestamp);
  //t->Loop();
