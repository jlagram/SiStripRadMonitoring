...
time_t convertTimestamp( std::string str){
  ...
  if(year==2013 || (year==2012 && month>=10) || (year==2022 && month>=10 ) || (year==2023 && month<=5 ) || (year==2023 && month==6 ) ) out_time+=3600;//FIXME : these conditions should alwayds be verfied (monitored)
