...
#ifndef ThresholdsAnalysisTreeMaker_h
#define ThresholdsAnalysisTreeMaker_h
...
class ThresholdsAnalysisTreeMaker {
public :
   ...
   ThresholdsAnalysisTreeMaker(TTree *tree=0, std::string file="Run.txt", int subdet=1, bool timestamp=false,
    int angle = 0, int width = 0, int onstrip = 0 );
   virtual ~ThresholdsAnalysisTreeMaker();
...
#ifdef ThresholdsAnalysisTreeMaker_cxx
ThresholdsAnalysisTreeMaker::ThresholdsAnalysisTreeMaker(TTree *tree, std::string file,
...
ThresholdsAnalysisTreeMaker::~ThresholdsAnalysisTreeMaker()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ThresholdsAnalysisTreeMaker::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ThresholdsAnalysisTreeMaker::LoadTree(Long64_t entry)
{
...
void ThresholdsAnalysisTreeMaker::Init(TTree *tree)
{
...
Bool_t ThresholdsAnalysisTreeMaker::Notify()
{
...
void ThresholdsAnalysisTreeMaker::Show(Long64_t entry)
{
...
Int_t ThresholdsAnalysisTreeMaker::Cut(Long64_t entry)
{
...
#endif // #ifdef ThresholdsAnalysisTreeMaker_cxx
