{
  ...
  TChain c("ttree");
  c.Add("root://eoscms//eos/cms/store/group/comm_tracker/Strip/RadMonitoring/SignalBiasScan/ClustersTrees/DecoSmallHVScan_20120728_199832_v1_2/clustersTree_*.root/demo/ttree");
  ...
  ClusterWidthAnalysisTreeMaker *t = new ClusterWidthAnalysisTreeMaker(&c, "../VoltageSteps/Steps/Steps_20120728_run199832.txt", subdet, usetimestamp);
  t->Loop();
