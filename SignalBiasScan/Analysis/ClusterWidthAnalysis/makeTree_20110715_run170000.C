{
  ...
  TChain c("ttree");
  c.Add("root://eoscms//eos/cms/store/group/comm_tracker/Strip/RadMonitoring/SignalBiasScan/ClustersTrees/DecoHVScan_20110715_run170000_v1_2/clustersTree*.root/demo/ttree");
  ...
  ClusterWidthAnalysisTreeMaker *t = new ClusterWidthAnalysisTreeMaker(&c, "../VoltageSteps/Steps/Steps_20110715_run170000.txt", subdet, usetimestamp);
  t->Loop();
