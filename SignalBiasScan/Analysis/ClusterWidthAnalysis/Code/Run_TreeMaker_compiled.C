...
int main()
{
  ...
  ClusterWidthAnalysisTreeMaker *t = new ClusterWidthAnalysisTreeMaker(&c, "../../VoltageSteps/Steps/Steps_20170924_run303824.txt", subdet, usetimestamp, angle, width, onstrip);
  t->Loop();
