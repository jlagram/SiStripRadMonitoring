...
int main()
{
  ...
  ClusterWidthAnalysisTreeMaker *t = new ClusterWidthAnalysisTreeMaker(&c, "../../VoltageSteps/Steps/Steps_20230907_run373060.txt", subdet, usetimestamp, angle, width, onstrip);
