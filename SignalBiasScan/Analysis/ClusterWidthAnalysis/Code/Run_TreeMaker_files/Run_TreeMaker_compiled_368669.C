...
int main()
{
  ...
  ClusterWidthAnalysisTreeMaker *t = new ClusterWidthAnalysisTreeMaker(&c, "../../VoltageSteps/Steps/Steps_20230609_run368669.txt", subdet, usetimestamp, angle, width, onstrip);
