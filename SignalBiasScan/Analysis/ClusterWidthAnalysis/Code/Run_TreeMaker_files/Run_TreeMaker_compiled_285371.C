...
int main()
{
  ...
  ClusterWidthAnalysisTreeMaker *t = new ClusterWidthAnalysisTreeMaker(&c, "../../VoltageSteps/Steps/Steps_20161116_run285371.txt", subdet, usetimestamp, angle, width, onstrip);
  t->Loop();
