...
int main()
{
  ...
  ClusterWidthAnalysisTreeMaker *t = new ClusterWidthAnalysisTreeMaker(&c, "../../VoltageSteps/Steps/Steps_20241012_run386863.txt", subdet, usetimestamp, angle, width, onstrip);
