...
int main()
{
  ...
  c.Add("root://eoscms//eos/cms/store/group/dpg_tracker_strip/comm_tracker/Strip/RadMonitoring/SignalBiasScan/ClustersTrees/DecoHVScan_20120405_run190459_v1_3/clustersTree*.root/demo/ttree");
