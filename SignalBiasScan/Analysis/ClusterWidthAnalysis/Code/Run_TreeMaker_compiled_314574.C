...
int main()
{
  ...
  c.Add("root://eoscms//eos/cms/store/group/dpg_tracker_strip/comm_tracker/Strip/RadMonitoring/Test/RUN314574.root/demo/ttree");
  ...
  ClusterWidthAnalysisTreeMaker *t = new ClusterWidthAnalysisTreeMaker(&c, "../../VoltageSteps/Steps/Steps_20180420_run314574.txt", subdet, usetimestamp, angle, width, onstrip);
  t->Loop();
