...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/store/data/Run2023A/EphemeralZeroBias0/ALCARECO/SiStripCalMinBias-20Apr2023_365843_SiStripCal-v1/2540000/44c864d7-8c9a-4b5a-b6d4-ea811ce268ea.root',
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('130X_dataRun3_Prompt_v2'),
