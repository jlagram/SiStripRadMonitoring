...
process.combinatorialcosmicseedfinderP5Bottom = cms.EDProducer("CtfSpecialSeedGenerator",
    ...
    MaxNumberOfPixelClusters = cms.uint32(300),
    MaxNumberOfStripClusters = cms.uint32(150),
    OrderedHitsFactoryPSets = cms.VPSet(
        cms.PSet(
            ComponentName = cms.string('GenericTripletGenerator'),
...
process.globalPixelLessSeeds = cms.EDProducer("SeedGeneratorFromRegionHitsEDProducer",
    ClusterCheckPSet = cms.PSet(
        ClusterCollectionLabel = cms.InputTag("siStripClusters"),
        MaxNumberOfPixelClusters = cms.uint32(40000),
        MaxNumberOfStripClusters = cms.uint32(5000),
        PixelClusterCollectionLabel = cms.InputTag("siPixelClusters"),
        cut = cms.string('strip < 400000 && pixel < 40000 && (strip < 50000 + 10*pixel) && (pixel < 5000 + 0.1*strip)'),
        doClusterCheck = cms.bool(True)
    ),
...
process.siPixelClustersPreSplittingAlpaka = cms.EDProducer("SiPixelRawToClusterPhase1@alpaka",
...
process.siPixelClustersPreSplittingAlpakaSerial = cms.EDProducer("alpaka_serial_sync::SiPixelRawToClusterPhase1",
    CablingMapLabel = cms.string(''),
    IncludeErrors = cms.bool(True),
    InputLabel = cms.InputTag("rawDataCollector"),
    Regions = cms.PSet(
...
process.siPixelDigiErrorsAlpaka = cms.EDProducer("SiPixelDigiErrorsFromSoAAlpaka",
    CablingMapLabel = cms.string(''),
...
process.siPixelDigiErrorsAlpakaSerial = cms.EDProducer("SiPixelDigiErrorsFromSoAAlpaka",
    CablingMapLabel = cms.string(''),
    ErrorList = cms.vint32(29),
    UsePhase1 = cms.bool(True),
    UserErrorList = cms.vint32(40),
...
process.jetsForCoreTrackingBarrel = cms.EDFilter("CandPtrSelector",
    cut = cms.string('pt > 100 && abs(eta) < 1.4'),
    filter = cms.bool(False),
    src = cms.InputTag("ak4CaloJetsForTrk")
)
...
process.trackSelectionTfDisplacedRegional = cms.ESProducer("TfGraphDefProducer",
    ComponentName = cms.string('trackSelectionTfDisplacedRegional'),
    FileName = cms.FileInPath('RecoTracker/FinalTrackSelectors/data/TrackTfClassifier/MkFitDisplacedRegionalOnly_Run3_12_5_0_pre5.pb'),
    appendToDataLabel = cms.string('')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('140X_dataRun3_Express_v3'),
