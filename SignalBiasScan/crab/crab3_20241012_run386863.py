...
config.General.requestName = 'HVscan_20241012_run386863_v1'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'signalbiasscan_20241012_run386863_cfg.py'

config.Data.inputDataset = '/ZeroBias/Run2024I-SiStripCalMinBias-PromptReco-v2/ALCARECO'
...
config.Data.lumiMask = 'DecoSmallHVScan_20241012_run386863_JSON.txt'
config.Data.runRange = '386863-386864' 
