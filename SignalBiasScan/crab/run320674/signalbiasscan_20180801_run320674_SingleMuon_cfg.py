...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2018D/SingleMuon/RECO/21Aug2018-v1/100000/FE184DD8-51A5-E811-8E89-003048F5B2B4.root'))
...
process.p = cms.Path(process.SingleMuonPaths_NoDoubleCounting + process.TrackRefitter*process.demo)
