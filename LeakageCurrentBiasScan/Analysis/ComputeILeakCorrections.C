...
void ComputeDCUOverPSRatios(std::string subdet, std::string run, int* detids, const int N, std::string bad_periods="")
{
  ...
  for(int idet=0; idet<N; idet++)
  {
	...
	npts = gratio->GetN();
    //Filling info
    cout<<"Filling info for detid "<<detid<<endl;
    tout->Fill();
...
//ComputeCorrections("TOB", "20180923_run323370", detids1, N1, "");
  ...
  // Run3
  // 2021
  //ComputeDCUOverPSRatios("TIB", "20211029_run346395", detids_2012_bis, N_2012_bis, "");
  //ComputeCorrections("TIB", "20211029_run346395", detids_2012_bis, N_2012_bis, "");
  //ComputeAllDCUOverPSRatios("TIB", "20220605_run353060", "Data/TIB_detids_sorted.txt", "");
  //ComputeAllCorrections("TIB", "20220605_run353060", "Data/TIB_detids_sorted.txt", "", 6, 50);
  ...
  //noise
  //ComputeCorrections("TIB", "noise_20120921_run203243", detids_2012_bis, N_2012_bis, "Steps/bad_periods_noise_20120921_run203243.txt");
  //ComputeAllDCUOverPSRatios("TIB", "noise_20120921_run203243", "Data/TIB_detids_sorted.txt", "");
  //ComputeAllCorrections("TIB", "noise_20120921_run203243", "Data/TIB_detids_sorted.txt", "Steps/bad_periods_noise_20120921_run203243.txt", 5, 50);
  //ComputeCorrections("TIB", "noise_20160914_run280667", detids_2012_bis, N_2012_bis, "Steps/bad_periods_noise_20160914_run280667.txt"); 
  //ComputeAllDCUOverPSRatios("TIB", "noise_20160914_run280667", "Data/TIB_detids_sorted.txt", "");
  //ComputeAllCorrections("TIB", "noise_20160914_run280667", "Data/TIB_detids_sorted.txt", "Steps/bad_periods_noise_20160914_run280667.txt", 5, 50);
  ...
  //ComputeCorrections("TIB", "noise_20210723_run343515", detids_2012_bis, N_2012_bis, "");
  //ComputeAllDCUOverPSRatios("TIB", "noise_20210723_run343515", "Data/TIB_detids_sorted.txt", "");
  //ComputeAllCorrections("TIB", "noise_20210723_run343515", "Data/TIB_detids_sorted.txt", "", 15, 50);
  //ComputeAllDCUOverPSRatios("TIB", "noise_20220928_run359476", "Data/TIB_detids_sorted.txt", "");
  //ComputeAllCorrections("TIB", "noise_20220928_run359476", "Data/TIB_detids_sorted.txt", "", 10, 50);
...
*/    
  ...
  // Run3
  // 2021
  //ComputeDCUOverPSRatios("TOB", "20211029_run346395", detids_TOB_2012, N_TOB_2012, "");
  //ComputeCorrections("TOB", "20211029_run346395", detids_TOB_2012, N_TOB_2012, "");
  //ComputeAllDCUOverPSRatios("TOB", "20220605_run353060", "Data/TOB_detids_sorted.txt", "");
  //ComputeAllCorrections("TOB", "20220605_run353060", "Data/TOB_detids_sorted.txt", "", 6, 50);
  //ComputeDCUOverPSRatios("TOB", "20221001_run359691", detids_TOB_2012, N_TOB_2012, "Steps/bad_periods_20221001_run359691.txt");
  //ComputeCorrections("TOB", "20221001_run359691", detids_TOB_2012, N_TOB_2012, "Steps/bad_periods_20221001_run359691.txt");
  //ComputeCorrections("TOB", "20221126_run362696", detids_TOB_2012, N_TOB_2012, "");
  //ComputeCorrections("TOB", "20230407_run365843", detids_TOB_2012, N_TOB_2012, "");
  //ComputeAllDCUOverPSRatios("TOB", "20230407_run365843", "Data/TOB_detids_sorted.txt", "");
  //ComputeAllCorrections("TOB", "20230407_run365843", "Data/TOB_detids_sorted.txt", "", 7, 50);
  

  //noise
  //ComputeCorrections("TOB", "noise_20120921_run203243", detids_TOB_2012, N_TOB_2012, "Steps/bad_periods_noise_20120921_run203243.txt");
  //ComputeAllDCUOverPSRatios("TOB", "noise_20120921_run203243", "Data/TOB_detids_sorted.txt", "Steps/bad_periods_noise_20120921_run203243.txt");
  //ComputeAllCorrections("TOB", "noise_20120921_run203243", "Data/TOB_detids_sorted.txt", "Steps/bad_periods_noise_20120921_run203243.txt", 3, 50);
  //ComputeCorrections("TOB", "noise_20160914_run280667", detids_TOB_2012, N_TOB_2012, "Steps/bad_periods_noise_20160914_run280667.txt");
  //ComputeAllDCUOverPSRatios("TOB", "noise_20160914_run280667", "Data/TOB_detids_sorted.txt", "Steps/bad_periods_noise_20160914_run280667.txt");
  //ComputeAllCorrections("TOB", "noise_20160914_run280667", "Data/TOB_detids_sorted.txt", "Steps/bad_periods_noise_20160914_run280667.txt");
  ...
  //ComputeCorrections("TOB", "noise_20171205_run307585", detids_TOB_2012, N_TOB_2012, "");
  //ComputeAllDCUOverPSRatios("TOB", "noise_20171205_run307585", "Data/TOB_detids_sorted.txt", "");
  //ComputeAllCorrections("TOB", "noise_20171205_run307585", "Data/TOB_detids_sorted.txt", "", 5, 50);
  ...
  //ComputeCorrections("TOB", "noise_20210723_run343515", detids_TOB_2012, N_TOB_2012, "");
  //ComputeAllDCUOverPSRatios("TOB", "noise_20210723_run343515", "Data/TOB_detids_sorted.txt", "");
  //ComputeAllCorrections("TOB", "noise_20210723_run343515", "Data/TOB_detids_sorted.txt", "", 5, 50);
  //ComputeAllDCUOverPSRatios("TOB", "noise_20220928_run359476", "Data/TOB_detids_sorted.txt", "");
  //ComputeAllCorrections("TOB", "noise_20220928_run359476", "Data/TOB_detids_sorted.txt", "", 4, 50);
...
*/  
  ...
  // Run3
  //ComputeAllDCUOverPSRatios("TID", "20220605_run353060", "Data/TID_detids_sorted.txt", "");
  //ComputeAllCorrections("TID", "20220605_run353060", "Data/TID_detids_sorted.txt", "", 6, 50);
  //ComputeAllDCUOverPSRatios("TID", "20230407_run365843", "Data/TID_detids_sorted.txt", "");
  //ComputeAllCorrections("TID", "20230407_run365843", "Data/TID_detids_sorted.txt", "", 9, 50);


  // noise
  //ComputeAllDCUOverPSRatios("TID", "noise_20120921_run203243", "Data/TID_detids_sorted.txt", "Steps/bad_periods_noise_20120921_run203243.txt");
  //ComputeAllCorrections("TID", "noise_20120921_run203243", "Data/TID_detids_sorted.txt", "Steps/bad_periods_noise_20120921_run203243.txt", 3, 50);
  //ComputeAllDCUOverPSRatios("TID", "noise_20160914_run280667", "Data/TID_detids_sorted.txt", "Steps/bad_periods_noise_20160914_run280667.txt");
  //ComputeAllCorrections("TID", "noise_20160914_run280667", "Data/TID_detids_sorted.txt", "Steps/bad_periods_noise_20160914_run280667.txt", 5, 50);
  ...
  //ComputeAllDCUOverPSRatios("TID", "noise_20171205_run307585", "Data/TID_detids_sorted.txt", "");
  //ComputeAllCorrections("TID", "noise_20171205_run307585", "Data/TID_detids_sorted.txt", "", 8, 50);
  ...
  //ComputeAllDCUOverPSRatios("TID", "noise_20210723_run343515", "Data/TID_detids_sorted.txt", "");
  //ComputeAllCorrections("TID", "noise_20210723_run343515", "Data/TID_detids_sorted.txt", "", 13, 50);
  //ComputeAllDCUOverPSRatios("TID", "noise_20220928_run359476", "Data/TID_detids_sorted.txt", "");
  //ComputeAllCorrections("TID", "noise_20220928_run359476", "Data/TID_detids_sorted.txt", "", 10, 50);
 ...
 /* ComputeDCUOverPSRatios("TEC", "20150603_run246963", detids_TEC, N_TEC, "Steps/bad_periods_20150603_run246963.txt"); 
  ...
  // Run3
  // 2021
  //ComputeDCUOverPSRatios("TEC", "20211029_run346395", detids_TEC, N_TEC, "");
  //ComputeCorrections("TEC", "20211029_run346395", detids_TEC, N_TEC, "");
  //ComputeAllDCUOverPSRatios("TEC", "20220605_run353060", "Data/TEC_detids_sorted.txt", "");
  //ComputeAllCorrections("TEC", "20220605_run353060", "Data/TEC_detids_sorted.txt", "", 3, 50);
  //ComputeDCUOverPSRatios("TEC", "20221001_run359691", detids_TEC, N_TEC, "Steps/bad_periods_20221001_run359691.txt");
  //ComputeCorrections("TEC", "20221001_run359691", detids_TEC, N_TEC, "Steps/bad_periods_20221001_run359691.txt");
  //ComputeCorrections("TEC", "20221126_run362696", detids_TEC, N_TEC, "");
  //ComputeCorrections("TEC", "20230407_run365843", detids_TEC, N_TEC, "");
  ...
  //ComputeAllDCUOverPSRatios("TEC", "noise_20120921_run203243", "Data/TEC_detids_sorted.txt", "Steps/bad_periods_noise_20120921_run203243.txt");
  //ComputeAllCorrections("TEC", "noise_20120921_run203243", "Data/TEC_detids_sorted.txt", "Steps/bad_periods_noise_20120921_run203243.txt", 3, 50);
  //ComputeAllDCUOverPSRatios("TEC", "noise_20160914_run280667", "Data/TEC_detids_sorted.txt", "Steps/bad_periods_noise_20160914_run280667.txt");
  //ComputeAllCorrections("TEC", "noise_20160914_run280667", "Data/TEC_detids_sorted.txt", "Steps/bad_periods_noise_20160914_run280667.txt", 3, 50);
  ...
  //ComputeCorrections("TEC", "noise_20171205_run307585", detids_TEC, N_TEC, "");
  //ComputeAllDCUOverPSRatios("TEC", "noise_20171205_run307585", "Data/TEC_detids_sorted.txt", "");
  //ComputeAllCorrections("TEC", "noise_20171205_run307585", "Data/TEC_detids_sorted.txt", "", 8, 50);
  ...
  //ComputeCorrections("TEC", "noise_20210723_run343515", detids_TEC, N_TEC, "");
  //ComputeAllDCUOverPSRatios("TEC", "noise_20210723_run343515", "Data/TEC_detids_sorted.txt", "");
  //ComputeAllCorrections("TEC", "noise_20210723_run343515", "Data/TEC_detids_sorted.txt", "", 4.5, 50);
  //ComputeAllDCUOverPSRatios("TEC", "noise_20220928_run359476", "Data/TEC_detids_sorted.txt", "");
  //ComputeAllCorrections("TEC", "noise_20220928_run359476", "Data/TEC_detids_sorted.txt", "", 4, 50);
