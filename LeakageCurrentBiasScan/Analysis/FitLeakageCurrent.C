...
std::pair<std::vector<float>,std::vector<float>> Fit(char* subdet, char* run,int LAY, int* detids, const int N, char* bad_periods="", float* Vinit = nullptr, const int NFIT = 10)
{
  ...
  int COUNT[10]= {0};// NFit = 10 
  int HotCOUNT[10]= {0};// NFit = 10 , that is the only real dependance to the number of fits in this code, else you just have to set NFIT to 10
  ...
  for(int idet=0; idet<N; idet++)
  {
   ...
   //!! Example to select modules from TEC R5 W9
  ...
  if ( RUN.Contains("2024") && subdet == "TEC" )
    {
...
if (subdet=="TIB")
  {
    if (RUN.Contains("2024") || RUN.Contains("2025"))
    {
      f1par2down = f1down[0] ; f1par2start= f1start[0]; f1par2end=f1up[0] ;
      f2par2down = f2down[2] ; f2par2start= f2start[0]; f2par2end=f2up[2] ;
      f3par2down = f3down[2] ; f3par2start= f3start[1]; f3par2end=f3up[2] ;
      f4par2down = f4down[3] ; f4par2start= f4start[1]; f4par2end=f4up[2] ;
    }
  ...
  if (subdet=="TOB" || subdet == "TEC")
  {
    if (RUN.Contains("2022") || RUN.Contains("2023") || RUN.Contains("2024") || RUN.Contains("2025")) 
        {
          f1par2down = f1down[0] ; f1par2start= f1start[0]; f1par2end=f1up[1] ;
          f2par2down = f2down[0] ; f2par2start= f2start[0]; f2par2end=f2up[4] ;
          f3par2down = f3down[0] ; f3par2start= f3start[0]; f3par2end=f3up[4] ;
          f4par2down = f4down[1] ; f4par2start= f4start[0]; f4par2end=f4up[1] ;
          if (RUN.Contains("365843"))
            {
                f3par2down = f3down[1] ; f3par2start= f3start[1]; f3par2end=f3up[4] ;
            }
          else if (LAY == 1 && RUN.Contains("2024"))
            {
              f1par2down = f1down[1] ; f1par2start= f1start[1]; f1par2end=f1up[2] ;
              f3par2down = f3down[2] ; f3par2start= f3start[1]; f3par2end=f3up[4] ;
            }
          else if (subdet == "TEC" &&  RUN.Contains("2024") )
            {
                if (RUN.Contains("378238"))
                  {
                    f2par2down = 150 ; f2par2start= 190; f2par2end=300 ;
                    f3par2down = 120 ; f3par2start= 175; f3par2end=200 ;
                    f4par2down = 120/*3**/ ; f4par2start= 145; f4par2end=190 ;
                    
                  }
                else if (RUN.Contains("388832"))
                  {
                    f2par2down = 150 ; f2par2start= 190; f2par2end=300 ;
                    f3par2down = 120 ; f3par2start= 220; f3par2end=f3up[2] ;
                    f4par2down = 120/*3**/ ; f4par2start= 145; f4par2end=190 ;
                  }

            }
          else if (subdet == "TEC" &&  RUN.Contains("2023") )
            {
              f3par2down = 120 ; f3par2start= 175; f3par2end=f3up[2] ;
              f4par2down = 145; f4par2start= 200; f4par2end=300 ;
            }
          else if (subdet == "TEC" &&  RUN.Contains("2022") )
            {
              f3par2down = f3down[2] ; f3par2start= f3start[2]; f3par2end=f3up[2] ;
               f4par2down = f4down[1]/*3**/ ; f4par2start= f4start[1]; f4par2end=f4up[2] ;
            }
        } 
    ...
    if (RUN.Contains("2018") )
      {
        ...
        if (subdet == "TEC")
          {
            f2par2down = 50 ; f2par2start= 150; f2par2end=200 ;
    ...
    if (RUN.Contains("2017") ) 
      {
        ...
        f3par2down = f3down[1] ; f3par2start= f3start[0]; f3par2end=f3up[1] ;
        f4par2down = f4down[1] ; f4par2start= f4start[0]; f4par2end=f4up[1] ;
        if (subdet == "TEC" &&  RUN.Contains("2017") )
            {
              
               f4par2down = 50/*3**/ ; f4par2start= 75; f4par2end=120 ;
            }
      }
    ...
    if (subdet=="TOB" &&  RUN.Contains("368669"))
      {
        Nchi2up = 20;
      }
    ...
    if (subdet=="TEC" &&  RUN.Contains("2024") && LAY == 5 )
      {
        Nchi2up = 80;
      }
    if(fvdrop->GetNDF())
   ...
   if (subdet=="TOB" &&  (RUN.Contains("2024") || RUN.Contains("2023") ) )
      {
        chi2up = 80;
      }
  if (subdet=="TEC" &&  (RUN.Contains("2024") || RUN.Contains("2023") ) )
      {
        chi2up = 80;
      }
    if(fvdrop3->GetNDF())
    ...
    lvdrop6->Draw();
    float CHI2UP = 5;
    if (subdet=="TIB" &&  (RUN.Contains("2024")) || RUN.Contains("2025"))
      {
        CHI2UP = 35;//sadly yes
      }
    if (subdet=="TOB" &&  (RUN.Contains("2024")) || RUN.Contains("2025") && LAY == 1 )
      {
        CHI2UP = 35;//sadly yes
      }
    if (subdet=="TEC" &&  (RUN.Contains("2024")) || RUN.Contains("2025") && LAY == 5 )
      {
        CHI2UP = 35;//sadly yes
      }
  ...
  if ( !RUN.Contains("2024"))
  {
    ...
    if (subdet=="TOB" && (RUN.Contains("2021") || RUN.Contains("2022") || RUN.Contains("2023")))
      {
        chi2up = 30;
      }
    if(fvdrop4->GetNDF())
  ...
  else if (RUN.Contains("2024") || RUN.Contains("2025"))
    {
    ...
    //------------------------------------------------------------//
        // General Function : TO derive the formula of the gerenal function, start from the second derivative and integrate twice
    //------------------------------------------------------------//
...
if ((RUN.Contains("20181018") || RUN.Contains("20230609"))  && subdet=="TOB" && LAY==1)
  {
    ...
    // // !! The free parameter is p.
      ...
      if ( (subdet == "TIB" ) && ((RUN.Contains("2024") || RUN.Contains("2025") ))&& LAY == 1)
        {
      ...
      // !! the vfd value is really sensitive to the k value, you can play with it to see the effect
      //
      if ( (subdet == "TOB" ) && RUN.Contains("2012") && (LAY == 4 || LAY == 5 || LAY == 6))
        {
          p = 0.82;
        }
      if ( (subdet == "TOB" ) && (RUN.Contains("2015") || RUN.Contains("2016") )&& (LAY == 4 || LAY == 5 || LAY == 6))
        {
          p = 0.84;
        }

      if ( (subdet == "TOB" ) && (RUN.Contains("2017") )&& (LAY == 4 || LAY == 5 || LAY == 6))
        {
          p = 0.93;
        }
      if ( (subdet == "TOB" ) && (RUN.Contains("2018") )&& (LAY == 4 || LAY == 5 || LAY == 6))
        {
          p = 0.97;
          if (RUN.Contains("20181018") || RUN.Contains("20181115"))
            {
      ...
      if ( (subdet == "TOB" ) && (RUN.Contains("2021") )&& (LAY == 4 || LAY == 5 || LAY == 6))
        {
          p = 0.95;
        }
      if ( (subdet == "TOB" ) && (RUN.Contains("2022") )&& (LAY == 4 || LAY == 5 || LAY == 6))
        {
          p = 0.95;
        }
      if ( (subdet == "TOB" ) && (RUN.Contains("2023") )&& (LAY == 4 || LAY == 5 || LAY == 6))
        {
          if (RUN.Contains("20230407") )
            {
              p = 0.91;
      ...
      if ( (subdet == "TOB" ) && (RUN.Contains("2024")|| RUN.Contains("2025")  )&& (LAY == 4 || LAY == 5 || LAY == 6))
        {
          if (RUN.Contains("20240910") )
            {
              p = 0.85;
...
if (subdet == "TEC"  && LAY == 5)
  ...
  // --------2D Derivative part ---------------------//
  //------------------------------------------------------------//
	// Look at the derivative as second part of the curve is a line
  ...
  float Vfd = 0;
  float fitderivdown[3] = {10,50,100};
  float fitderivup[3]   = {300,350,280};
  float fderivdown[4]  = {130,190,230,40};
  float fderivstart[6] = {100,150,250,300,200,80};
...
if (subdet=="TOB")
  {
    ...
    if (RUN.Contains("2024")   ) 
      {
        fderiv1par2down = fderivdown[3] ; fderiv1par2start= fderivstart[5]; fderiv1par2end=fderivup[1] ;
        // fderiv2par2down = fderivdown[1] ; fderiv2par2start= fderivstart[1]; fderiv2par2end=fderivup[3] ;
      } 
    if (RUN.Contains("2025")   ) 
      {
    ...
    || (subdet == "TEC" && LAY ==5 && RUN.Contains("388832") ) || RUN.Contains("2025")
    )
      {
        ...
        {
          if (fvdropderiv->GetChisquare()/fvdropderiv->GetNDF()<5 || (subdet == "TOB" && LAY==4 && RUN.Contains("2024")&& fvdropderiv->GetChisquare()/fvdropderiv->GetNDF()<15 )
          || (subdet == "TEC" && LAY == 5 && RUN.Contains("2024")&& fvdropderiv->GetChisquare()/fvdropderiv->GetNDF()<15 ) || ( RUN.Contains("2025")&& fvdropderiv->GetChisquare()/fvdropderiv->GetNDF()<15 )
          )
          {
            bool skip = false;
            if (COUNT[4]!=0)
...
if ((RUN.Contains("2025") ||RUN.Contains("2024")|| RUN.Contains("2023")|| RUN.Contains("2022") || RUN.Contains("2021")|| RUN.Contains("2018") || RUN.Contains("2017") ))
  {
    //Initiliazed with TIB values
    if ( !(subdet == "TOB" && (LAY==4 || LAY == 1) && RUN.Contains("2024") || (subdet == "TOB" && LAY ==1 && RUN.Contains("373060") ))
        || (subdet == "TEC" && LAY ==5 && RUN.Contains("3888832") ) || RUN.Contains("2025") 
    )
      {
    ...
    // Gaussian fit
     ...
     std::cout<<"End of  Fit of deriv with exp"<<std::endl;
      ...
      if (RUN.Contains("2024") && !(subdet == "TEC"))
        {
          Vfd = fvdropderiv->GetParameter(2)+3*fvdropderiv->GetParameter(3);//approx.  mean + 5*stddev
        }
    ...
    if (subdet == "TOB" || subdet == "TEC" )
      {
        ...
        par3start = 70;
        par3up = 150;
        if ( (RUN.Contains("2022") && subdet == "TEC"))
          {
            par2down = 25;
            par2start = 35;
            par2up = 60;
        ...
        if ( (RUN.Contains("2023") && subdet == "TEC"))
          {
            par2down = 15;
            par2start = 30;
            par2up = 60;
        ...
        if ( (RUN.Contains("20240321_run378238") && subdet == "TEC")) 
          {
            par2down = 25;
            par2start = 35;
            par2up = 60;
    ...
    if (subdet == "TIB" && ( RUN.Contains("2023") || RUN.Contains("2024") || RUN.Contains("2025")))
      {
        par2down = 30;
        par2start = 50;
        par2up = 60;
        ...
        if  (RUN.Contains("386863") || RUN.Contains("388832"))
          {
            par2down = 60;
            par2start = 80;
            par2up = 100;
      ...
      if(TriL->GetNDF())
      {
        if (( TriL->GetChisquare()/TriL->GetNDF()<5) || (subdet == "TOB" && LAY==4 && RUN.Contains("2024") && TriL->GetChisquare()/TriL->GetNDF()<15) 
          || (subdet == "TEC" && LAY==5 && RUN.Contains("2024") && TriL->GetChisquare()/TriL->GetNDF()<15) || ( RUN.Contains("2025") && TriL->GetChisquare()/TriL->GetNDF()<15)
        )
          {
            bool skip = false;
            if (COUNT[5]!=0)
            ...
            // c2->cd();
      TLine* lvdropderiv = new TLine(TriL->GetParameter(3), ymin,TriL->GetParameter(3), ymax);
      lvdropderiv->SetLineStyle(2);
      lvdropderiv->SetLineColor(44);
      lvdropderiv->SetLineWidth(2);
      lvdropderiv->Draw("same");
    ...
    //------------------------------------------//
      ...
      if (subdet == "TOB" && RUN.Contains("2024") && LAY == 4)
        ...
        {
          if (RUN.Contains("2025") ) {k = 0.6;}
          if (RUN.Contains("2024") && RUN.Contains("388832")) {k = 0.6;}
          if (RUN.Contains("2024") && RUN.Contains("20240321_run378238")) {k = 0.8;}
          if (RUN.Contains("2023")) {k = 0.835;}
          if (RUN.Contains("2022")) {k = 0.875;}
        }
      
      
      if (RUN.Contains("388832") && (subdet == "TOB" || subdet == "TIB"))
        {
          k = 0.98;
        }
      ...
      {
        if (fvdropderivGen->GetChisquare()/fvdropderivGen->GetNDF()<5 || RUN.Contains("388832")  
            || (subdet == "TOB" && LAY==4 && RUN.Contains("2024") && fvdropderivGen->GetChisquare()/fvdropderivGen->GetNDF()<15)
            || (subdet == "TOB" && LAY==4 && RUN.Contains("2025") && fvdropderivGen->GetChisquare()/fvdropderivGen->GetNDF()<15)
        )
          {
            bool skip = false;
            if (COUNT[8]!=0)
            ...
            // !! --------------------------------------------
            // define a specific Vfd value for Run 388832
            if (RUN.Contains("388832"))
              {
                  // -par[0]/sqrt(par[1])*atan(sqrt(par[1])*(x[0]-par[2]))+exp(par[3]*x[0]-par[4])+(par[0]/sqrt(par[1]))*3.14/2
                  TF1 *fsolve = new TF1("fsolve", 
                          "(-[0]/sqrt([1]))*atan(sqrt([1])*(x-[2])) + exp([3]*x-[4]) + ([0]/sqrt([1]))*3.14/2", 
                          10, 350); // Intervalle d'intérêt

                      // Initialiser les paramètres (tu peux ajuster ces valeurs)
                      fsolve->SetParameter(0, fvdropderivGen->GetParameter(0));  // par[0]
                      fsolve->SetParameter(1, fvdropderivGen->GetParameter(1));  // par[1]
                      fsolve->SetParameter(2, fvdropderivGen->GetParameter(2));  // par[2]
                      fsolve->SetParameter(3, fvdropderivGen->GetParameter(3));  // par[3]
                      fsolve->SetParameter(4, fvdropderivGen->GetParameter(4));  // par[4]

                      // Trouver le minimum dans l'intervalle [-10, 10]
                      // double min_val = f->GetMinimum(-10, 10);   // Valeur minimale
                      Vfd = fsolve->GetMinimumX(10, 350);   // Position x correspondante
              }
...
//--------------------------------------------//
  ...
  if (subdet=="TIB")
    {
      ...
      if (  RUN.Contains("2025")) {up = 200; down = 20;curvmax = 0.008; mean = 100;
  ...
  if (subdet=="TOB" )
    {          
      if (   RUN.Contains("2025")) {up = 250; down = 20;curvmax = 0.008; mean = 100;
    ...
    {
      if (RUN.Contains("2025")) {up = 300; down = 30;curvmax = 0.008; mean = 200;
                              meandown = 150; meanup= 300;}
      if (RUN.Contains("2024")) {up = 300; down = 30;curvmax = 0.008; mean = 200;
                              meandown = 150; meanup= 300;}
      if (  RUN.Contains("2023") ) {up = 300; down = 20;curvmax = 0.03; curvmin = 0.01;mean = 1550;
                                    meandown = 50; meanup= 175;}
      if (  RUN.Contains("2022") ) {up = 200; down = 20;curvmax = 0.03; curvmin = 0.01;mean = 100;
                                    meandown = 50; meanup= 150;}
      if ( RUN.Contains("2021")  ) {up = 160; down = 20;curvmax = 0.01; mean = 100;
                                    meandown = 50; meanup= 150;}    
    ...
    if (RUN.Contains("386863") && subdet=="TIB" ){VFDfromCurve = xminCURV;}//|| RUN.Contains("388832")  We lack extra points above 300 GeV, so it's hard to fit
      if(fcurv->GetNDF())
      {
  ...
  //------------------------------------------//
    ...
    if (RUN.Contains("386863") && subdet == "TIB"){CurvVfd = xminCURV;}// || RUN.Contains("388832")  We lack extra points above 300 GeV, so it's hard to fit
    if(fcurvGen->GetNDF())
      {
  ...
  //     cd->SaveAs(Form("Ileak_Deriv_%s_%i.png", run, detid));
      // AvoidExcessofPlots++;
  //   }
     if (subdet == "TEC" && AvoidExcessofPlots < 15 )
    {
      // c1->SaveAs(Form("Ileak-Vbias_%s_%i.png", run, detid));
      // c2->SaveAs(Form("IleakEffect_%s_%i.png", run, detid));
      // c3->SaveAs(Form("IleakCurvature_%s_%i.png", run, detid));
...
std::pair<std::vector<std::vector<float>>,std::vector<std::vector<float>>> FitLeakageCurrent(char* subdet="TIB",  char* run="20230907_run373060", int LAY=1 , bool Small = true, const int nfit=10)
{
  ...
  std::string line;
  int cnt = 0;
  const int NFit = nfit; // !!  numberof fits performed
  ...
  std::pair<std::vector<float>,std::vector<float>> Fit17;
  // 2012
  if (Small)
    {
      if (subdet == "TIB")
        {
          ...
          Fit0 = Fit("TIB", "20120506_run193541", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit1 = Fit("TIB", "20151121_run262254", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit2 = Fit("TIB", "20160706_run276437", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit3 = Fit("TIB", "20160909_run280385", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit4 = Fit("TIB", "20171030_run305862", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit5 = Fit("TIB", "20180530_run317182", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit6 = Fit("TIB", "20180611_run317683", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit7 = Fit("TIB", "20181018_run324841", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit8 = Fit("TIB", "20181115_run326776", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit9 = Fit("TIB", "20211029_run346395", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit10 = Fit("TIB", "20220605_run353060", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit11 = Fit("TIB", "20230407_run365843", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit12 = Fit("TIB", "20230609_run368669", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit13 = Fit("TIB", "20230907_run373060", LAY , detids_2012, N_2012, "",Vinit, NFit);
	        Fit14 = Fit("TIB", "20240702_run382655", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit15 = Fit("TIB", "20240910_run385515", LAY , detids_2012, N_2012, "",Vinit, NFit);
	        Fit16 = Fit("TIB", "20241012_run386863", LAY , detids_2012, N_2012, "",Vinit, NFit);
          Fit17 = Fit("TIB", "20241125_run388832", LAY , detids_2012, N_2012, "",Vinit, NFit);//noise
      ...
      else if (subdet == "TOB")
        {
          ...
          Fit0 = Fit("TOB", "20120506_run193541", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit1 = Fit("TOB", "20151121_run262254", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit2 = Fit("TOB", "20160706_run276437", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit3 = Fit("TOB", "20160909_run280385", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit4 = Fit("TOB", "20171030_run305862", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit5 = Fit("TOB", "20180530_run317182", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit6 = Fit("TOB", "20180611_run317683", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit7 = Fit("TOB", "20181018_run324841", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit8 = Fit("TOB", "20181115_run326776", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit9 = Fit("TOB", "20211029_run346395", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit10 = Fit("TOB", "20220605_run353060", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit11 = Fit("TOB", "20230407_run365843", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit12 = Fit("TOB", "20230609_run368669", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit13 = Fit("TOB", "20230907_run373060", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
	        Fit14 = Fit("TOB", "20240702_run382655", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          Fit15 = Fit("TOB", "20240910_run385515", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
	        Fit16 = Fit("TOB", "20241012_run386863", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);
          // Fit17 = Fit("TOB", "20241125_run388832", LAY , detids_TOB_2012, N_TOB_2012, "",Vinit, NFit);//noise
      ...
      if (subdet == "TIB")
      ...
      else if (subdet == "TOB")
        {
          ...
          while (std::getline(input, line) )
            ...
            Fit0 = Fit("TOB", "20120510_run193928", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
            Fit1 = Fit("TOB", "20160423_run271056", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
            Fit2 = Fit("TOB", "20170527_run295376", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
            Fit3 = Fit("TOB", "20170924_run303824", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
            Fit4 = Fit("TOB", "20180418_run314574", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
            Fit5 = Fit("TOB", "20180923_run323370", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
            Fit6 = Fit("TOB", "20220605_run353060", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
            Fit7 = Fit("TOB", "20230407_run365843", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
            Fit8 = Fit("TOB", "20240321_run378238", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
            // Fit9 = Fit("TOB", "20241125_run388832", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);//noise

	    //Fit8 = Fit("TOB", "20230321_run378238", LAY, detids_FullTOB_2012, N_FullTOB_2012, "",Full_Vinit, NFit);
        ...
        {
          std::ifstream input( "TEC_list.txt" );//TOB_list
          const int N_FullTEC_2012=538;//In fact, not full list of TEC modules, just the ones from TEC R5 wheel 9
          int detids_FullTEC_2012[N_FullTEC_2012]={0};
          float Full_Vinit[N_FullTEC_2012]= {0};
            //--------------Full Scans -----------------//
            bool SKIP = false;
          while (std::getline(input, line) )
              {
            ...
            Fit0 = Fit("TEC", "20120510_run193928", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);
            Fit1 = Fit("TEC", "20160423_run271056", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);
            Fit2 = Fit("TEC", "20170527_run295376", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);
            Fit3 = Fit("TEC", "20170924_run303824", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);
            Fit4 = Fit("TEC", "20180418_run314574", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);
            Fit5 = Fit("TEC", "20180923_run323370", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);
            Fit6 = Fit("TEC", "20220605_run353060", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);
            Fit7 = Fit("TEC", "20230407_run365843", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);
            Fit8 = Fit("TEC", "20240321_run378238", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);
            Fit9 = Fit("TEC", "20241125_run388832", LAY, detids_FullTEC_2012, N_FullTEC_2012, "",Full_Vinit, NFit);//noise
...
int PlotMeanVfdPerRunwPerFit (std::vector<std::vector<float>> VFD, std::vector<float> LUMI,TString subdet , TString LAY, bool SMALL, const int NFIT) 
  {
    ...
    leg->Draw("SAME");
      ...
      //  t2->DrawLatex(18,310," L_{int} = 260 fb^{-1}");
        ...
        else if (subdet=="TEC") {text = "Tracker EndCap R"+LAY;dx = 275;}
  ...
  if(superimpose_simu)
  {
      ...
      if(choice_simu == 0) {simufile_name = dirname+"/simulation/VdepGraphs_TIB_2017.root";}
      ...
      else if(choice_simu == 5) 
        {
          if (subdet == "TIB")
            {
              simufile_name = "/afs/cern.ch/user/p/pvaucell/public/VdepEvolution/Predictions/lumigr_TIB_L"+LAY+".root";
              FILE = "lumigr_TIB_L"+LAY;
            }
          if (subdet == "TOB")
            {
              simufile_name = "/afs/cern.ch/user/p/pvaucell/public/VdepEvolution/Predictions/lumigr_TOB_L"+LAY+".root";
              FILE = "lumigr_TOB_L"+LAY;
            }
          else if (subdet == "TID")
            {
              simufile_name = "/afs/cern.ch/user/p/pvaucell/public/VdepEvolution/Predictions/lumigr_TID_R"+LAY+".root";
              FILE = "lumigr_"+LAY;
            }
          else if (subdet == "TEC")
            {
              simufile_name = "/afs/cern.ch/user/p/pvaucell/public/VdepEvolution/Predictions/lumigr_TEC_R"+LAY+".root";
              FILE = "lumigr_"+LAY;
            }
        }
    ...
    else if (subdet=="TEC") {save_text = "TEC_R"+LAY;}
...
int PlotDeltaMeanVfdPerRunPerFit (std::vector<std::vector<float>> VFD, std::vector<float> LUMI,TString subdet , TString LAY, bool SMALL, const int NFIT) 
  {
    if (VFD.size()==0)// number of runs
      {
        std::cout<<"Number of Runs to be analyzed is 0. Please look a the FitLeakageCurrent function"<<std::endl;
  ...
  if(superimpose_simu)
  {
    ...
    else if (subdet=="TEC") {save_text = "DeltaTEC_R"+LAY;}
    if (SMALL){save_text = save_text+"SMALLSCAN";}
    else {save_text = save_text+"FULLSCAN";}
    c1->SaveAs(save_text+".root");
    c1->SaveAs(save_text+".pdf");
...
//
//-------------------------------------------------------------------------//
// !! You have to wait for Jean-Laurent to produce the leakage current vs Vbiais curves then yo ucan run the code
// To add a new run, there are multiple steps:
// 1- Add the integrated lumi in the Lumi vector
// 2- Add the run at the beginning of the FitLeakageCurrent function (becareful, do it for TIB, TOB for smallscan or fullscan) (line ~ 2450)
...
// For a given fit, you can adjust the chi2 selection for the fit, sometimes how you want to retrieve the Vfd value (especially for the general method)
...
// If the statistic is low during a scan for whatever reason, you can add intermediate points between the steps to have a better idea of the evolution of the Vfd :
// see : line ~ 180
...
int main()
  {
    ...
    std::vector<std::vector<float>> MeanVfdTEC;
    std::vector<float> Lumi;
    std::vector<float> LumiTEC;
    ...
    if (SmallScan)
      {
        ...
        // Run3
            ...
            // !! FIT PARAMETERS are not completely fully optimized for the last 4 runs. May be some improvements can be done
            ...
            if (noisescan)
              {
                Lumi.push_back(391); //run 388832 //noise
              }             
...
else  
  {
    ...
    // // // Run3
        ...
        //--------------------------//
    //     LumiTEC.push_back(7.4);//run :20120510_run193928
    // // // // // Run2
    //     LumiTEC.push_back(33);//run :20160423_run271056
    //     LumiTEC.push_back(74);//run :20170527_run295376
    //     LumiTEC.push_back(100);//run : 20170924_run303824
    //     LumiTEC.push_back(126);//run 20180418_run314574
    //     LumiTEC.push_back(181);//run 20180923_run323370
    // // // // Run3
    //     LumiTEC.push_back(195);//run :20220605_run353060 : Full
    //     LumiTEC.push_back(235);//run :20230407_run365843: Full
	      LumiTEC.push_back(266); //run : 378238-239 : Full
        LumiTEC.push_back(391); //run 388832 //noise
    ...
    // // Vfd
    // // --------------------------------------------------------//
    DATATOB = FitLeakageCurrent("TOB","",5,SmallScan,NFIT);
    MeanVfdTOB = DATATOB.first;
    PlotMeanVfdPerRunwPerFit(MeanVfdTOB,Lumi,"TOB","5",SmallScan,NFIT);
    //--------------------------------------------------------//
    // Delta Vfd-Vinit mean
    //--------------------------------------------------------//
    MeanVfdTOB = DATATOB.second;
    PlotDeltaMeanVfdPerRunPerFit(MeanVfdTOB,Lumi,"TOB","5",SmallScan,NFIT);
    
    //--------------------------------------------------------//
    // Vfd
    //--------------------------------------------------------//
    DATATOB = FitLeakageCurrent("TOB","",6,SmallScan,NFIT);
    MeanVfdTOB = DATATOB.first;
    PlotMeanVfdPerRunwPerFit(MeanVfdTOB,Lumi,"TOB","6",SmallScan,NFIT);
    //--------------------------------------------------------//
    // Delta Vfd-Vinit mean
    //--------------------------------------------------------//
    MeanVfdTOB = DATATOB.second;
    PlotDeltaMeanVfdPerRunPerFit(MeanVfdTOB,Lumi,"TOB","6",SmallScan,NFIT);
