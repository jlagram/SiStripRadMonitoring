...
def print_leakcurcorr_evolution(files, detid=369125870, temperature=False):
...
print RUN_LUMI
files = list_tree_files('~/work/public/SiStripRadMonitoring/LeakageCurrentCorrections/Corrections/wDCUcur/LeakCurCorr_TIB_*.root')
files_temperature = list_tree_files('~/work/public/SiStripRadMonitoring/LeakageCurrentCorrections/Data/DCU/DCU_I_*.root')
...
#print_leakcurcorr_evolution(files, 369125870)
#print_leakcurcorr_evolution(files_temperature, 369125870, True)
